...
#define CONST_TOTALMENUELEMENTS  15 // maximum amount of elements(functions) in menu 
...
#define I2C_ADDRESS 0x3C  //0x3C mine or 0x3D need to find out with :LINK:http://playground.arduino.cc/Main/I2cScanner
...
public:bool InterfaceDinamic() {
	...
	else
	{
		...
		boolSetMenu = false; //activate condition ones until event is triggered
