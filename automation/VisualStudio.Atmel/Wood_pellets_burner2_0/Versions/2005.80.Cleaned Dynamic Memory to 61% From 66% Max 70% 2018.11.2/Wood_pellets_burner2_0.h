...
//	printMenuFunc("Gran. Greitis", &PELLETPUSHERMINSPEED, "RPM:");// DONT TOCHT ONLY IN PROGRAMMER MODE SETTINGS ALLOWED
	...
	printMenuFunc("Fanas "+Cold, &FANMAXSPEED, Burning + " "+RPM, &__FANMINSPEEDMAX);
	printMenuFunc("Fanas "+Hot, &FANMINSPEED, Burning + " "+RPM, &__FANMINSPEEDMIN, false, "Less", FANMAXSPEED.getValue()-1);
