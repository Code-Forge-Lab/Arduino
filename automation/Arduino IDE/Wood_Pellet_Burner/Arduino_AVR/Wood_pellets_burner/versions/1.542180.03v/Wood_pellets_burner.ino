...
controls FANMINSPEED(3,100); //address

controls FANSECONDSHOLD(4,20); //address
// Pellets            
...
//  printMenuFunc("Gran.Activuoti",&PELLETPUSHERENABLE,"OFF/ON:");
 ...
 void funPelletModeTempMinOrMax ()
 {
  analogWrite (PELLETPUSHERPIN,0); // disable pellet pusher 
  printMenuFunc("Gran. Greitis",&PELLETPUSHERMINSPEED,"RPM:"); 
  printMenuFunc("Gran.Greitis Min",&PELLETPUSHERMINUTESOFF,"min:");
...
//                       
               ...
               case 3 :
                      ...
                      lcd.setCursor(0,1);
                      lcd.print("C* max:"+ String (MAXTEMP.getValue()) + ",C:"+ String(Temperature.Temperature));    // Temperature.Temperature
                 break;     
               case 4 :
...
//           PELLETPUSHERMINSPEED.getVaule();
         ...
         switch(PELLETPUSHERMODE.getValue()) 
         {
          ...
          // Just in case if timer still going somewhere and to stop in sum point
