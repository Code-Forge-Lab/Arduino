...
void Inv_On_Auto_on () {
    ...
    if (ActivateOneHourWhenPassed ) {
         ...
         if (output6State == "on" && timeClient.getHours() == 12) {Serial.println(" at " + String (autoTOn1));  turnOnHeatingTimeout (); }
    else if (output7State == "on" && timeClient.getHours() == 13) {Serial.println(" at " + String (autoTOn2));  turnOnHeatingTimeout (); }
    else if (output8State == "on" && timeClient.getHours() == 14) {Serial.println(" at " + String (autoTOn3));  turnOnHeatingTimeout (); }
    else if (output9State == "on" && timeClient.getHours() == 15) {Serial.println(" at " + String (autoTOn4));  turnOnHeatingTimeout (); }
